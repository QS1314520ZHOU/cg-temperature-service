...
/* 11 */     this.userId = userId; } public void setTime(Date time) { this.time = time; } public void setAction(String action) { this.action = action; } public boolean equals(Object o) { if (o == this) return true;  if (!(o instanceof DeleteRecord)) return false;  DeleteRecord other = (DeleteRecord)o; if (!other.canEqual(this)) return false;  Object this$userId = getUserId(), other$userId = other.getUserId(); if ((this$userId == null) ? (other$userId != null) : !this$userId.equals(other$userId)) return false;  Object this$time = getTime(), other$time = other.getTime(); if ((this$time == null) ? (other$time != null) : !this$time.equals(other$time)) return false;  Object this$action = getAction(), other$action = other.getAction(); return !((this$action == null) ? (other$action != null) : !this$action.equals(other$action)); } protected boolean canEqual(Object other) { return other instanceof DeleteRecord; } public int hashCode() { int PRIME = 59; int result = 1; Object $userId = getUserId(); result = result * 59 + (($userId == null) ? 43 : $userId.hashCode()); Object $time = getTime(); result = result * 59 + (($time == null) ? 43 : $time.hashCode()); Object $action = getAction(); return result * 59 + (($action == null) ? 43 : $action.hashCode()); } public String toString() { return "DeleteRecord(userId=" + getUserId() + ", time=" + getTime() + ", action=" + getAction() + ")"; }
/*    */   
