...
/* 12 */     this.value = value; } public void setShowStr(String showStr) { this.showStr = showStr; } public boolean equals(Object o) { if (o == this) return true;  if (!(o instanceof ConfigItemDto)) return false;  ConfigItemDto other = (ConfigItemDto)o; if (!other.canEqual(this)) return false;  Object this$value = getValue(), other$value = other.getValue(); if ((this$value == null) ? (other$value != null) : !this$value.equals(other$value)) return false;  Object this$showStr = getShowStr(), other$showStr = other.getShowStr(); return !((this$showStr == null) ? (other$showStr != null) : !this$showStr.equals(other$showStr)); } protected boolean canEqual(Object other) { return other instanceof ConfigItemDto; } public int hashCode() { int PRIME = 59; result = 1; Object $value = getValue(); result = result * 59 + (($value == null) ? 43 : $value.hashCode()); Object $showStr = getShowStr(); return result * 59 + (($showStr == null) ? 43 : $showStr.hashCode()); } public String toString() { return "ConfigItemDto(value=" + getValue() + ", showStr=" + getShowStr() + ")"; }
/*    */ 
/*    */   
