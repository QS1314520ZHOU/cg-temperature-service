...
/* 12 */     this.name = name; } public void setGroups(List<Group> groups) { this.groups = groups; } public boolean equals(Object o) { if (o == this) return true;  if (!(o instanceof Tab)) return false;  Tab other = (Tab)o; if (!other.canEqual(this)) return false;  Object this$name = getName(), other$name = other.getName(); if ((this$name == null) ? (other$name != null) : !this$name.equals(other$name)) return false;  Group this$groups = (Group)getGroups(), other$groups = (Group)other.getGroups(); return !((this$groups == null) ? (other$groups != null) : !this$groups.equals(other$groups)); } protected boolean canEqual(Object other) { return other instanceof Tab; } public int hashCode() { int PRIME = 59; int result = 1; Object $name = getName(); result = result * 59 + (($name == null) ? 43 : $name.hashCode()); Group $groups = (Group)getGroups(); return result * 59 + (($groups == null) ? 43 : $groups.hashCode()); } public String toString() { return "Tab(name=" + getName() + ", groups=" + getGroups() + ")"; } public Tab(String name, List<Group> groups) {
