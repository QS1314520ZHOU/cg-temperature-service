...
/* 13 */     this.name = name; } public void setItems(List<Item> items) { this.items = items; } public boolean equals(Object o) { if (o == this) return true;  if (!(o instanceof Group)) return false;  Group other = (Group)o; if (!other.canEqual(this)) return false;  Object this$name = getName(), other$name = other.getName(); if ((this$name == null) ? (other$name != null) : !this$name.equals(other$name)) return false;  Item this$items = (Item)getItems(), other$items = (Item)other.getItems(); return !((this$items == null) ? (other$items != null) : !this$items.equals(other$items)); } protected boolean canEqual(Object other) { return other instanceof Group; } public int hashCode() { int PRIME = 59; int result = 1; Object $name = getName(); result = result * 59 + (($name == null) ? 43 : $name.hashCode()); Item $items = (Item)getItems(); return result * 59 + (($items == null) ? 43 : $items.hashCode()); } public String toString() { return "Group(name=" + getName() + ", items=" + getItems() + ")"; }
